import { Resolvers, QueryCache, NewErrorsOutputObj } from '../typedefs.ts';

export const newErrors = (gqlQuery: string, resolvers: Resolvers, currentQuery: string, queryCache: QueryCache, schema: string) : NewErrorsOutputObj => {
